...
<ParamField body="scope" type="string" required>
  El alcance de acceso solicitado. En v3 usa scopes por mercado, por ejemplo: `bonds:read cedears:read stocks:read`.
  
  <Tip>
  Puedes solicitar múltiples scopes separados por espacio para habilitar varios mercados con un solo token.
  </Tip>
</ParamField>
